...
logI "Tagging ${AZ_ACR_CANONICAL_UMRS_CONTAINER_IMAGE_FULL_NAME} to ${AZ_ACR_CANONICAL_UMRS_CONTAINER_IMAGE_FULL_NAME}-${MY_d}"
buildah tag "${AZ_ACR_CANONICAL_UMRS_CONTAINER_IMAGE_FULL_NAME}" "${AZ_ACR_CANONICAL_UMRS_CONTAINER_IMAGE_FULL_NAME}-${MY_d}"

logI "Pushing tag ${AZ_ACR_CANONICAL_UMRS_CONTAINER_IMAGE_FULL_NAME}-${MY_d}"
buildah push "${AZ_ACR_CANONICAL_UMRS_CONTAINER_IMAGE_FULL_NAME}-${MY_d}"
